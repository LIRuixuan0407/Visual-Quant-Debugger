...
const COLUMN_BY_TYPE: Record<LineageNodeType, number> = { DATASET: 0, UNIVERSE: 0, CORPORATE_ACTION_DATASET: 0, FACTOR: 1, FACTOR_RESEARCH: 2, FACTOR_RELATIONSHIP: 3, WALK_FORWARD: 3, PORTFOLIO_RESEARCH: 3, HYPOTHESIS: 4, STRATEGY: 5, RUN: 6, TRACE: 7, SNAPSHOT: 7, FORWARD_SESSION: 6, PAPER_SESSION: 6, DRIFT_REPORT: 7 }
