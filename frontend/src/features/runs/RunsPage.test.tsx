...
test('lists, filters, selects, annotates, opens historical artifacts, reruns, and deletes', async () => {
  ...
  render(<RunsPage strategies={[strategyDefinition]} datasets={[dataset]} onOpenReplay={onReplay} onOpenDiagnose={onDiagnose} onOpenAutopsy={onAutopsy} onLoadConfiguration={onLoadConfiguration} services={api} />)
